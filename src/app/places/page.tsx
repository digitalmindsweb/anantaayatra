...
export default function PlacesList() {
  const places = CONTENT_DATA.filter(c => c.type === 'place');
      ...
      <main className="flex-1 w-full pt-32 pb-32 bg-slate-50 dark:bg-slate-950 min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-left mb-16 border-b border-slate-200 dark:border-slate-800 pb-10">
            <h1 className="text-5xl md:text-6xl font-serif font-black text-slate-900 dark:text-white mb-6 tracking-tight">Places to Visit</h1>
