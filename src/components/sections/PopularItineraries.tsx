...
export default function PopularItineraries() {
  ...
  return (
    <section className="py-32 bg-brand-50/50 dark:bg-slate-900/50 border-t border-slate-100 dark:border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
          <div className="max-w-2xl">
            <h2 className="text-sm font-bold tracking-widest text-brand-600 uppercase mb-3">Curated Journeys</h2>
            <h3 className="text-5xl md:text-6xl font-serif font-black text-slate-900 dark:text-white tracking-tight">Popular Itineraries</h3>
